...
namespace GuitarConfiguratorSharp.NetCore
{
    public struct Board
    {
        ...
        new Board("mega2560-atmega16u2", "Arduino Mega 2560", 0, "arduino_uno_mega_usb16", new List<uint>{0x2FEF}, true),
        new Board("mega2560-at90usb82", "Arduino Mega 2560", 0, "arduino_uno_mega_usb8", new List<uint>{0x2FF7}, true),
        new Board("mega2560", "Arduino Mega 2560", 0, "arduino_mega_2560", new List<uint>{0x0010, 0x0042}, true),
        new Board("megaadk-atmega16u2", "Arduino Mega ADK", 0, "arduino_uno_mega_usb16", new List<uint>{0x2FEF}, true),
        new Board("megaadk-at90usb82", "Arduino Mega ADK", 0, "arduino_uno_mega_usb8", new List<uint>{0x2FF7}, true),
        ...
        new Board("uno-atmega16u2", "Arduino Uno", 0, "arduino_uno_mega_usb16", new List<uint>{0x2FEF}, true),
